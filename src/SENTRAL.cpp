...
void Sentral::CheckMotionDetection()
{
  sentral_motion = readByte(EM7180_ADDRESS, EM7180_AlgorithmStatus);
  sentral_motion = (((sentral_motion >> 2) & 0x01));
}

void Sentral::PrintSerial(bool SerialDebug)
{
...
void Sentral::Update(bool passThru)
{
  ...
  if (!passThru)
  {
    ...
    { // error detected, what is it?
      ...
      if (errorStatus != 0x00)
      { // non-zero value indicates error, what is it?
...
void Sentral::SetMode(bool passThru, bool SerialDebug)
{
  if (!passThru)
  {
...
void Sentral::FindEM7180Sensors()
{
